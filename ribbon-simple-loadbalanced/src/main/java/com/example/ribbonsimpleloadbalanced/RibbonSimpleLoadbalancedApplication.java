package com.example.ribbonsimpleloadbalanced;
...
public class RibbonSimpleLoadbalancedApplication {

    public static void main(String[] args) {
        SpringApplication.run(RibbonSimpleLoadbalancedApplication.class, args);
    }
    ...
    /**
     * Ribbon自身的负载均衡算法:
     * RoundRobinRule(轮询算法)  Ribbon默认是轮询
     * RandomRule(随机算法)
